...
void RecoAnalyzer::initHistograms()
{
  ...
  // RecHits for Beams
  thePosTECR4Beam0RecHits = new TH2D("Beam0","RecHits of Beam 0 in Ring 4 in TEC+", 100, 0.0, 100.0, 200, 100.0, 300.0);
  thePosTECR4Beam0RecHits->SetDirectory(Ring4Beam0PosDir);
  thePosTECR4Beam0RecHits->GetXaxis()->SetTitle("z [cm]");
  thePosTECR4Beam0RecHits->GetYaxis()->SetTitle("R [cm]");
  thePosTECR4Beam1RecHits = new TH2D("Beam1","RecHits of Beam 1 in Ring 4 in TEC+", 100, 0.0, 100.0, 200, 100.0, 300.0);
  thePosTECR4Beam1RecHits->SetDirectory(Ring4Beam1PosDir);
  thePosTECR4Beam1RecHits->GetXaxis()->SetTitle("z [cm]");
  thePosTECR4Beam1RecHits->GetYaxis()->SetTitle("R [cm]");
  thePosTECR4Beam2RecHits = new TH2D("Beam2","RecHits of Beam 2 in Ring 4 in TEC+", 100, 0.0, 100.0, 200, 100.0, 300.0);
  thePosTECR4Beam2RecHits->SetDirectory(Ring4Beam2PosDir);
  thePosTECR4Beam2RecHits->GetXaxis()->SetTitle("z [cm]");
  thePosTECR4Beam2RecHits->GetYaxis()->SetTitle("R [cm]");
  thePosTECR4Beam3RecHits = new TH2D("Beam3","RecHits of Beam 3 in Ring 4 in TEC+", 100, 0.0, 100.0, 200, 100.0, 300.0);
  thePosTECR4Beam3RecHits->SetDirectory(Ring4Beam3PosDir);
  thePosTECR4Beam3RecHits->GetXaxis()->SetTitle("z [cm]");
  thePosTECR4Beam3RecHits->GetYaxis()->SetTitle("R [cm]");
  thePosTECR4Beam4RecHits = new TH2D("Beam4","RecHits of Beam 4 in Ring 4 in TEC+", 100, 0.0, 100.0, 200, 100.0, 300.0);
  thePosTECR4Beam4RecHits->SetDirectory(Ring4Beam4PosDir);
  thePosTECR4Beam4RecHits->GetXaxis()->SetTitle("z [cm]");
  thePosTECR4Beam4RecHits->GetYaxis()->SetTitle("R [cm]");
  thePosTECR4Beam5RecHits = new TH2D("Beam5","RecHits of Beam 5 in Ring 4 in TEC+", 100, 0.0, 100.0, 200, 100.0, 300.0);
  thePosTECR4Beam5RecHits->SetDirectory(Ring4Beam5PosDir);
  thePosTECR4Beam5RecHits->GetXaxis()->SetTitle("z [cm]");
  thePosTECR4Beam5RecHits->GetYaxis()->SetTitle("R [cm]");
  thePosTECR4Beam6RecHits = new TH2D("Beam6","RecHits of Beam 6 in Ring 4 in TEC+", 100, 0.0, 100.0, 200, 100.0, 300.0);
  thePosTECR4Beam6RecHits->SetDirectory(Ring4Beam6PosDir);
  thePosTECR4Beam6RecHits->GetXaxis()->SetTitle("z [cm]");
  thePosTECR4Beam6RecHits->GetYaxis()->SetTitle("R [cm]");
  thePosTECR4Beam7RecHits = new TH2D("Beam7","RecHits of Beam 7 in Ring 4 in TEC+", 100, 0.0, 100.0, 200, 100.0, 300.0);
  thePosTECR4Beam7RecHits->SetDirectory(Ring4Beam7PosDir);
  thePosTECR4Beam7RecHits->GetXaxis()->SetTitle("z [cm]");
  thePosTECR4Beam7RecHits->GetYaxis()->SetTitle("R [cm]");

  thePosTECR6Beam0RecHits = new TH2D("Beam0","RecHits of Beam 0 in Ring 6 in TEC+", 100, 0.0, 100.0, 200, 100.0, 300.0);
  thePosTECR6Beam0RecHits->SetDirectory(Ring6Beam0PosDir);
  thePosTECR6Beam0RecHits->GetXaxis()->SetTitle("z [cm]");
  thePosTECR6Beam0RecHits->GetYaxis()->SetTitle("R [cm]");
  thePosTECR6Beam1RecHits = new TH2D("Beam1","RecHits of Beam 1 in Ring 6 in TEC+", 100, 0.0, 100.0, 200, 100.0, 300.0);
  thePosTECR6Beam1RecHits->SetDirectory(Ring6Beam1PosDir);
  thePosTECR6Beam1RecHits->GetXaxis()->SetTitle("z [cm]");
  thePosTECR6Beam1RecHits->GetYaxis()->SetTitle("R [cm]");
  thePosTECR6Beam2RecHits = new TH2D("Beam2","RecHits of Beam 2 in Ring 6 in TEC+", 100, 0.0, 100.0, 200, 100.0, 300.0);
  thePosTECR6Beam2RecHits->SetDirectory(Ring6Beam2PosDir);
  thePosTECR6Beam2RecHits->GetXaxis()->SetTitle("z [cm]");
  thePosTECR6Beam2RecHits->GetYaxis()->SetTitle("R [cm]");
  thePosTECR6Beam3RecHits = new TH2D("Beam3","RecHits of Beam 3 in Ring 6 in TEC+", 100, 0.0, 100.0, 200, 100.0, 300.0);
  thePosTECR6Beam3RecHits->SetDirectory(Ring6Beam3PosDir);
  thePosTECR6Beam3RecHits->GetXaxis()->SetTitle("z [cm]");
  thePosTECR6Beam3RecHits->GetYaxis()->SetTitle("R [cm]");
  thePosTECR6Beam4RecHits = new TH2D("Beam4","RecHits of Beam 4 in Ring 6 in TEC+", 100, 0.0, 100.0, 200, 100.0, 300.0);
  thePosTECR6Beam4RecHits->SetDirectory(Ring6Beam4PosDir);
  thePosTECR6Beam4RecHits->GetXaxis()->SetTitle("z [cm]");
  thePosTECR6Beam4RecHits->GetYaxis()->SetTitle("R [cm]");
  thePosTECR6Beam5RecHits = new TH2D("Beam5","RecHits of Beam 5 in Ring 6 in TEC+", 100, 0.0, 100.0, 200, 100.0, 300.0);
  thePosTECR6Beam5RecHits->SetDirectory(Ring6Beam5PosDir);
  thePosTECR6Beam5RecHits->GetXaxis()->SetTitle("z [cm]");
  thePosTECR6Beam5RecHits->GetYaxis()->SetTitle("R [cm]");
  thePosTECR6Beam6RecHits = new TH2D("Beam6","RecHits of Beam 6 in Ring 6 in TEC+", 100, 0.0, 100.0, 200, 100.0, 300.0);
  thePosTECR6Beam6RecHits->SetDirectory(Ring6Beam6PosDir);
  thePosTECR6Beam6RecHits->GetXaxis()->SetTitle("z [cm]");
  thePosTECR6Beam6RecHits->GetYaxis()->SetTitle("R [cm]");
  thePosTECR6Beam7RecHits = new TH2D("Beam7","RecHits of Beam 7 in Ring 6 in TEC+", 100, 0.0, 100.0, 200, 100.0, 300.0);
  thePosTECR6Beam7RecHits->SetDirectory(Ring6Beam7PosDir);
  thePosTECR6Beam7RecHits->GetXaxis()->SetTitle("z [cm]");
  thePosTECR6Beam7RecHits->GetYaxis()->SetTitle("R [cm]");

  theNegTECR4Beam0RecHits = new TH2D("Beam0","RecHits of Beam 0 in Ring 4 in TEC-", 100, 0.0, 100.0, 200, -100.0, -300.0);
  theNegTECR4Beam0RecHits->SetDirectory(Ring4Beam0NegDir);
  theNegTECR4Beam0RecHits->GetXaxis()->SetTitle("z [cm]");
  theNegTECR4Beam0RecHits->GetYaxis()->SetTitle("R [cm]");
  theNegTECR4Beam1RecHits = new TH2D("Beam1","RecHits of Beam 1 in Ring 4 in TEC-", 100, 0.0, 100.0, 200, -100.0, -300.0);
  theNegTECR4Beam1RecHits->SetDirectory(Ring4Beam1NegDir);
  theNegTECR4Beam1RecHits->GetXaxis()->SetTitle("z [cm]");
  theNegTECR4Beam1RecHits->GetYaxis()->SetTitle("R [cm]");
  theNegTECR4Beam2RecHits = new TH2D("Beam2","RecHits of Beam 2 in Ring 4 in TEC-", 100, 0.0, 100.0, 200, -100.0, -300.0);
  theNegTECR4Beam2RecHits->SetDirectory(Ring4Beam2NegDir);
  theNegTECR4Beam2RecHits->GetXaxis()->SetTitle("z [cm]");
  theNegTECR4Beam2RecHits->GetYaxis()->SetTitle("R [cm]");
  theNegTECR4Beam3RecHits = new TH2D("Beam3","RecHits of Beam 3 in Ring 4 in TEC-", 100, 0.0, 100.0, 200, -100.0, -300.0);
  theNegTECR4Beam3RecHits->SetDirectory(Ring4Beam3NegDir);
  theNegTECR4Beam3RecHits->GetXaxis()->SetTitle("z [cm]");
  theNegTECR4Beam3RecHits->GetYaxis()->SetTitle("R [cm]");
  theNegTECR4Beam4RecHits = new TH2D("Beam4","RecHits of Beam 4 in Ring 4 in TEC-", 100, 0.0, 100.0, 200, -100.0, -300.0);
  theNegTECR4Beam4RecHits->SetDirectory(Ring4Beam4NegDir);
  theNegTECR4Beam4RecHits->GetXaxis()->SetTitle("z [cm]");
  theNegTECR4Beam4RecHits->GetYaxis()->SetTitle("R [cm]");
  theNegTECR4Beam5RecHits = new TH2D("Beam5","RecHits of Beam 5 in Ring 4 in TEC-", 100, 0.0, 100.0, 200, -100.0, -300.0);
  theNegTECR4Beam5RecHits->SetDirectory(Ring4Beam5NegDir);
  theNegTECR4Beam5RecHits->GetXaxis()->SetTitle("z [cm]");
  theNegTECR4Beam5RecHits->GetYaxis()->SetTitle("R [cm]");
  theNegTECR4Beam6RecHits = new TH2D("Beam6","RecHits of Beam 6 in Ring 4 in TEC-", 100, 0.0, 100.0, 200, -100.0, -300.0);
  theNegTECR4Beam6RecHits->SetDirectory(Ring4Beam6NegDir);
  theNegTECR4Beam6RecHits->GetXaxis()->SetTitle("z [cm]");
  theNegTECR4Beam6RecHits->GetYaxis()->SetTitle("R [cm]");
  theNegTECR4Beam7RecHits = new TH2D("Beam7","RecHits of Beam 7 in Ring 4 in TEC-", 100, 0.0, 100.0, 200, -100.0, -300.0);
  theNegTECR4Beam7RecHits->SetDirectory(Ring4Beam7NegDir);
  theNegTECR4Beam7RecHits->GetXaxis()->SetTitle("z [cm]");
  theNegTECR4Beam7RecHits->GetYaxis()->SetTitle("R [cm]");

  theNegTECR6Beam0RecHits = new TH2D("Beam0","RecHits of Beam 0 in Ring 6 in TEC-", 100, 0.0, 100.0, 200, -100.0, -300.0);
  theNegTECR6Beam0RecHits->SetDirectory(Ring6Beam0NegDir);
  theNegTECR6Beam0RecHits->GetXaxis()->SetTitle("z [cm]");
  theNegTECR6Beam0RecHits->GetYaxis()->SetTitle("R [cm]");
  theNegTECR6Beam1RecHits = new TH2D("Beam1","RecHits of Beam 1 in Ring 6 in TEC-", 100, 0.0, 100.0, 200, -100.0, -300.0);
  theNegTECR6Beam1RecHits->SetDirectory(Ring6Beam1NegDir);
  theNegTECR6Beam1RecHits->GetXaxis()->SetTitle("z [cm]");
  theNegTECR6Beam1RecHits->GetYaxis()->SetTitle("R [cm]");
  theNegTECR6Beam2RecHits = new TH2D("Beam2","RecHits of Beam 2 in Ring 6 in TEC-", 100, 0.0, 100.0, 200, -100.0, -300.0);
  theNegTECR6Beam2RecHits->SetDirectory(Ring6Beam2NegDir);
  theNegTECR6Beam2RecHits->GetXaxis()->SetTitle("z [cm]");
  theNegTECR6Beam2RecHits->GetYaxis()->SetTitle("R [cm]");
  theNegTECR6Beam3RecHits = new TH2D("Beam3","RecHits of Beam 3 in Ring 6 in TEC-", 100, 0.0, 100.0, 200, -100.0, -300.0);
  theNegTECR6Beam3RecHits->SetDirectory(Ring6Beam3NegDir);
  theNegTECR6Beam3RecHits->GetXaxis()->SetTitle("z [cm]");
  theNegTECR6Beam3RecHits->GetYaxis()->SetTitle("R [cm]");
  theNegTECR6Beam4RecHits = new TH2D("Beam4","RecHits of Beam 4 in Ring 6 in TEC-", 100, 0.0, 100.0, 200, -100.0, -300.0);
  theNegTECR6Beam4RecHits->SetDirectory(Ring6Beam4NegDir);
  theNegTECR6Beam4RecHits->GetXaxis()->SetTitle("z [cm]");
  theNegTECR6Beam4RecHits->GetYaxis()->SetTitle("R [cm]");
  theNegTECR6Beam5RecHits = new TH2D("Beam5","RecHits of Beam 5 in Ring 6 in TEC-", 100, 0.0, 100.0, 200, -100.0, -300.0);
  theNegTECR6Beam5RecHits->SetDirectory(Ring6Beam5NegDir);
  theNegTECR6Beam5RecHits->GetXaxis()->SetTitle("z [cm]");
  theNegTECR6Beam5RecHits->GetYaxis()->SetTitle("R [cm]");
  theNegTECR6Beam6RecHits = new TH2D("Beam6","RecHits of Beam 6 in Ring 6 in TEC-", 100, 0.0, 100.0, 200, -100.0, -300.0);
  theNegTECR6Beam6RecHits->SetDirectory(Ring6Beam6NegDir);
  theNegTECR6Beam6RecHits->GetXaxis()->SetTitle("z [cm]");
  theNegTECR6Beam6RecHits->GetYaxis()->SetTitle("R [cm]");
  theNegTECR6Beam7RecHits = new TH2D("Beam7","RecHits of Beam 7 in Ring 6 in TEC-", 100, 0.0, 100.0, 200, -100.0, -300.0);
  theNegTECR6Beam7RecHits->SetDirectory(Ring6Beam7NegDir);
  theNegTECR6Beam7RecHits->GetXaxis()->SetTitle("z [cm]");
  theNegTECR6Beam7RecHits->GetYaxis()->SetTitle("R [cm]");
}
